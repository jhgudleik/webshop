            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">URL-адрес</div>
                        @error('slug')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="category_id"
                            ...
                            @foreach(\App\Models\Category::orderBy('title')->get() as $cat)
                                <option value="{{ $cat->id }}" @selected(old('category_id', $entry->category_id) == $cat->id)>
                                    {{ $cat->title }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-check mb-4">
                        <input type="checkbox"
                               ...
                               @checked(old('active', $entry->active))>
